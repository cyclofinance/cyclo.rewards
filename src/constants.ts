...
export function validateAddress(value: string, field: string): void {
  if (!VALID_ADDRESS_REGEX.test(value))
    throw new Error(`Invalid ${field}: "${value}" is not a valid address`);
}
...
export const EPOCHS: Epoch[] = [
  ...
  },
  {
    ...
    seed: "cyclo-rewards-for-nov-2025",
    startBlock: 49772029,
    endBlock: 51355293,
  },
  {
    ...
    seed: "cyclo-rewards-for-dec-2025",
    startBlock: 51355293,
    endBlock: 52936176,
  },
  {
    ...
    seed: "cyclo-rewards-for-jan-2026",
    startBlock: 52936176,
    endBlock: 54506725,
  },
  {
    ...
    seed: "e18b5100f9b97f8c88f3a79de3d82fdd",
    startBlock: 54506725,
    endBlock: 56142314,
  },
  {
    ...
    seed: "7dd2a4c0ddf7ee0f0411904572454481",
    startBlock: 56142314,
    endBlock: 57729994,
  },
